...
const routeSeo = [
    ...
    [/^\/information\/data\/nickname$/, "information.data.nickname", true],
    [/^\/information\/data\/player-detail$/, "information.data.playerDetail", true],
    ...
    [/^\/developer$/, "developer"],
    [/^\/about$/, "about"],
    [/^\/emoji\/create$/, "emoji.create", true],
    [/^\/emoji\/list$/, "emoji.list", true],
    ...
    [/^\/event\/city-reward$/, "event.cityReward", true],
