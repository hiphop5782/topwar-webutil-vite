    ...
    return (
        <>
            ...
            <div className="row mt-4">
                <div className="col-3 text-primary">결과 수 :</div>
            ...
            <div className="row mt-2">
                <div className="col-3 text-primary">포인트 합계 :</div>
                <div className="col-9 fw-bold">
            ...
            <div className="row mt-2">
                <div className="col-3 text-primary">1인당 평균 포인트 :</div>
                <div className="col-9 fw-bold">
            ...
            <div className="row mt-2">
                <div className="col-3 text-danger">IQR 합계 :</div>
                <div className="col-9 fw-bold">
