...
import { FaArrowRotateRight, FaFloppyDisk, FaPlus, FaRecycle, FaXmark } from "react-icons/fa6";
    ...
    return (<>
        ...
        <div className="row mt-4">
            ...
            <div className="col-sm-9 d-flex align-items-center">
                ...
                <button className="btn btn-danger ms-4 text-nowrap" onClick={createVote}>
